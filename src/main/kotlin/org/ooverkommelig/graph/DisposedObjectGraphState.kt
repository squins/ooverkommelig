...
internal class DisposedObjectGraphState : FollowingObjectGraphState {
    ...
    override fun creationStarted(definition: ObjectCreatingDefinition<*>, argument: Any?) = throw UnsupportedOperationException("Cannot create objects while disposed.")
