...
fun <TObject> collectionProvidedByMe(): Collection<Definition<TObject>> = throw notOverriddenInObjectException()
...
fun <TObject, TParameter> collectionProvidedByMeParameterized(): Collection<ParameterizedDefinition<TObject, TParameter>> = throw notOverriddenInObjectException()
