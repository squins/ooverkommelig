...
abstract class AspectDefinition<TInterface : Any> {
    ...
    @Suppress("UNCHECKED_CAST")
    fun <TActualInterface : TInterface> weave(
        interfaceClass: Class<TActualInterface>,
        wrappedDefinition: Definition<TActualInterface>
    ): Definition<TActualInterface> =
        create(interfaceClass, wrappedDefinition, delegate as AspectDelegate<TActualInterface>)

    internal abstract fun <TActualInterface : TInterface> create(
        interfaceClass: Class<TActualInterface>,
        wrappedDefinition: Definition<TActualInterface>,
        delegateTypedWithInterface: AspectDelegate<TActualInterface>
    ): Definition<TActualInterface>
}
